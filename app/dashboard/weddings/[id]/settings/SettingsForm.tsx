    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <input
          ...
          spellCheck={false}
          disabled={released}
          className="min-h-[44px] w-full max-w-md rounded border border-gray-300 px-3 py-2 text-base text-foreground bg-white focus:outline-none focus:ring-2 focus:ring-foreground/20 focus-visible:ring-2 disabled:opacity-60"
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {released && slugTrimmed && (
          <a
            ...
            className="min-h-[44px] px-4 py-2 rounded border border-gray-300 font-medium text-foreground hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-foreground/20 focus-visible:ring-2 inline-flex items-center"
          >
            View site →
          </a>
        )}
